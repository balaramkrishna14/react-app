...
class CountriesDashBoardApp extends React.Component{
        ...
        render(){
            ...
            return(
                <div className={selectedTheme === "light" ? "countries-dashboard-body-light-mode" : "countries-dashboard-body-dark-mode"}>
                    <Header selectedTheme={selectedTheme} onChangeTheme={onChangeTheme}/>
                    <div>
                    <CountriesFilterBar filterCountriesBySearchText={this.filterCountriesBySearchText} 
                    filterCountriesBySelectedRegion={this.filterCountriesBySelectedRegion} selectedTheme={selectedTheme}/>                    
                    <Countries countries={selectedCountries} selectedTheme={selectedTheme}/>
                    </div>
                </div>
                );
        }
